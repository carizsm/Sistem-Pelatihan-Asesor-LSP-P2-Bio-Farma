...
@section('title', 'Tambah Data TNA')

{{-- Judul yang tampil di navbar atas --}}
@section('page_title', 'Evaluasi 1 - Tambah Data TNA')
...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        {{-- Form action dinonaktifkan sementara --}}
        <form action="#" method="POST" onsubmit="alert('Data TNA tidak disimpan (dummy mode).'); return false;" enctype="multipart/form-data">
            @csrf 
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg mb-8">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" class="w-full px-4 py-2 border rounded-lg bg-gray-100 text-gray-500 cursor-not-allowed" value="TNA.202510.002" readonly>
                    </div>
                    <div>
                        <label for="tanggal_pengajuan" class="block text-sm font-medium text-gray-700 mb-1">Tanggal Pengajuan</label>
                        <input type="date" id="tanggal_pengajuan" name="tanggal_pengajuan" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="periode" name="periode" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" placeholder="Contoh: Q4 2025" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="nik_pembuat" name="nik_pembuat" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" value="6821408" readonly>
                    </div>

                    <div>
                        <label for="jabatan_pembuat" class="block text-sm font-medium text-gray-700 mb-1">Jabatan Pembuat</label>
                        <input type="text" id="jabatan_pembuat" name="jabatan_pembuat" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" value="Admin" readonly>
                    </div>
                    <div>
                        <label for="unit_kerja_pembuat" class="block text-sm font-medium text-gray-700 mb-1">Unit Kerja Pembuat</label>
                        <input type="text" id="unit_kerja_pembuat" name="unit_kerja_pembuat" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" value="IT" readonly>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="jenis_pelatihan" name="jenis_pelatihan" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" placeholder="Contoh: Soft Skill" required>
                    </div>
                    <div>
                        <label for="metode_pelatihan" class="block text-sm font-medium text-gray-700 mb-1">Metode Pelatihan</label>
                        <input type="text" id="metode_pelatihan" name="metode_pelatihan" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" placeholder="Contoh: In-House" required>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg mb-8">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" id="tanggal_mulai" name="tanggal_mulai" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" required>
                    </div>
                    <div>
                        <label for="tanggal_selesai" class="block text-sm font-medium text-gray-700 mb-1">Tanggal Selesai</label>
                        <input type="date" id="tanggal_selesai" name="tanggal_selesai" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" required>
                    </div>
                    
                    <div>
                        <label for="jam_mulai" class="block text-sm font-medium text-gray-700 mb-1">Jam Mulai</label>
                        <input type="time" id="jam_mulai" name="jam_mulai" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" required>
                    </div>
                    <div>
                        <label for="jam_selesai" class="block text-sm font-medium text-gray-700 mb-1">Jam Selesai</label>
                        <input type="time" id="jam_selesai" name="jam_selesai" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" required>
                    </div>

                    <div>
                        <label for="pembicara" class="block text-sm font-medium text-gray-700 mb-1">Pembicara</label>
                        <input type="text" id="pembicara" name="pembicara" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" placeholder="Nama Pembicara/Instruktur" required>
                    </div>
                    <div>
                        <label for="status_kegiatan" class="block text-sm font-medium text-gray-700 mb-1">Status Kegiatan</label>
                        <input type="text" id="status_kegiatan" name="status_kegiatan" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" placeholder="Contoh: Pertama, Kedua, Ketiga, dst." required>
                    </div>

                    <div class="col-span-2">
                         <label class="block text-sm font-medium text-gray-700 mb-1">File SPT Instruktur</label>
                         <div class="flex space-x-2">
                            <input type="file" id="file_spt" name="file_spt" class="hidden" required>
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg mb-8">
                ...
                <div class="grid grid-cols-2 gap-6 mb-4">
                    <div>
                        ...
                        <textarea id="alasan" name="alasan" rows="4" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" required></textarea>
                    </div>
                    <div>
                        <label for="kondisi_sebelum" class="block text-sm font-medium text-gray-700 mb-1">Kondisi Sebelum</label>
                        <textarea id="kondisi_sebelum" name="kondisi_sebelum" rows="4" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" required></textarea>
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-6 mb-4">
                    <div>
                        <label for="tujuan" class="block text-sm font-medium text-gray-700 mb-1">Tujuan</label>
                        <textarea id="tujuan" name="tujuan" rows="4" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" required></textarea>
                    </div>
                    <div>
                        <label for="kondisi_diharapkan" class="block text-sm font-medium text-gray-700 mb-1">Kondisi Diharapkan</label>
                        <textarea id="kondisi_diharapkan" name="kondisi_diharapkan" rows="4" class="w-full px-4 py-2 border rounded-lg focus:ring-lsp-primary focus:border-lsp-primary bg-white text-gray-800" required></textarea>
                    </div>
                </div>
                <div>
                    ...
                    <table class="min-w-full leading-normal">
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">Diah Novitasari</td>
                                <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">6801397</td>
                                <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">Teknologi Informasi</td>
                            </tr>
                            <tr class="hover:bg-gray-50">
                                <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">Budi Santoso</td>
                                <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">11223344</td>
                                <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">Penjaminan Mutu dan Mitra Manufaktur</td>
                            </tr>
                            {{-- Anda bisa menambahkan baris kosong di sini untuk visualisasi tabel panjang --}}
