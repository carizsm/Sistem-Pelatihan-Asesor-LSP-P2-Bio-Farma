...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex justify-center mt-8">
            <a href="{{ route('admin.quiz_results.index') }}" class="px-8 py-3 text-lg border border-gray-500 text-white font-semibold rounded-lg shadow-sm bg-gray-500 hover:bg-gray-600 transition duration-200">
                Kembali
            </a>
        </div>
    </div>
