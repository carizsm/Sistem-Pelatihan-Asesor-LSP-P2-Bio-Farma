...
@section('content')
    <div class="flex justify-between items-center mb-6">
        ...
        {{-- Tombol untuk Tambah Data TNA --}}
        {{-- Ganti '#' dengan route yang sesuai ke halaman tambah TNA --}}
        <a href="{{ url('admin/tna/tambah') }}" class="bg-lsp-green text-white font-semibold py-2 px-4 rounded-lg shadow hover:bg-green-700 transition duration-200">
            Tambah Data TNA
        </a>
    </div>
            ...
            <table class="min-w-full leading-normal">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">TNA.202509.001</td>
                        <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">21/09/2025</td>
                        <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">Microsoft Excel</td>
                        <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">Pertama</td>
                        <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">Jaenudin</td>
                        <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                            {{-- Tombol Edit --}}
                            <a href="{{ url('admin/tna/ubah/1') }}" class="text-orange-500 hover:text-orange-700 mx-1">
                            ...
                            {{-- Tombol Hapus --}}
                            <button type="button" onclick="alert('Hapus TNA ini?')" class="text-red-500 hover:text-red-700 mx-1">
