        ...
        <main class="flex-1 flex flex-col">
            <div class="flex-1 px-6 pb-6 pt-2 flex flex-col space-y-3">
                ...
                <div class="bg-white rounded-xl shadow-sm p-8 flex-1 overflow-y-auto">
                    <div class="space-y-8">
                        {{-- Soal 1 --}}
                        <div class="quiz-item">
                            <h3 class="text-lg font-bold mb-4">1. Apa Pilar utama dari metode SCRUM ?</h3>
                            <div class="space-y-3 ml-4">
                                <label class="flex items-center gap-3 cursor-pointer group">
                                    <input type="radio" name="question1" value="A" class="w-5 h-5 text-[#17A2B8] focus:ring-[#17A2B8] cursor-pointer">
                                    <span class="text-base group-hover:text-[#17A2B8] transition">A. Lorem Ipsum</span>
                                </label>
                                <label class="flex items-center gap-3 cursor-pointer group">
                                    <input type="radio" name="question1" value="B" class="w-5 h-5 text-[#17A2B8] focus:ring-[#17A2B8] cursor-pointer">
                                    <span class="text-base group-hover:text-[#17A2B8] transition">B. Lorem Ipsum</span>
                                </label>
                                <label class="flex items-center gap-3 cursor-pointer group">
                                    <input type="radio" name="question1" value="C" class="w-5 h-5 text-[#17A2B8] focus:ring-[#17A2B8] cursor-pointer">
                                    <span class="text-base group-hover:text-[#17A2B8] transition">C. Lorem Ipsum</span>
                                </label>
                                <label class="flex items-center gap-3 cursor-pointer group">
                                    <input type="radio" name="question1" value="D" class="w-5 h-5 text-[#17A2B8] focus:ring-[#17A2B8] cursor-pointer">
                                    <span class="text-base group-hover:text-[#17A2B8] transition">D. Lorem Ipsum</span>
                                </label>
                            </div>
                        </div>
                        {{-- Soal X (abu-abu) --}}
                        <div class="quiz-item opacity-40">
                            <h3 class="text-lg font-bold mb-4 text-gray-500">X. Apa Pilar utama dari metode SCRUM ?</h3>
                            <div class="space-y-3 ml-4">
                                <label class="flex items-center gap-3">
                                    <input type="radio" name="questionX1" value="A" disabled class="w-5 h-5">
                                    <span class="text-base text-gray-500">A. Lorem Ipsum</span>
                                </label>
                                <label class="flex items-center gap-3">
                                    <input type="radio" name="questionX1" value="B" disabled class="w-5 h-5">
                                    <span class="text-base text-gray-500">B. Lorem Ipsum</span>
                                </label>
                                <label class="flex items-center gap-3">
                                    <input type="radio" name="questionX1" value="C" disabled class="w-5 h-5">
                                    <span class="text-base text-gray-500">C. Lorem Ipsum</span>
                                </label>
                                <label class="flex items-center gap-3">
                                    <input type="radio" name="questionX1" value="D" disabled class="w-5 h-5">
                                    <span class="text-base text-gray-500">D. Lorem Ipsum</span>
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex items-center justify-center bg-[#F3F3F3] rounded-xl shadow-sm mx-6 mb-2">
                <div class="flex items-center gap-3 px-6 py-2">
                    <button class="p-2 rounded-lg bg-[#D9E7E9] shadow-sm hover:bg-[#c0d5d7] transition">
                        <img src="{{ asset('icons/Nav Backwards.svg') }}" class="w-4 h-4" alt="Previous">
                    </button>
                    <span class="text-sm text-gray-600 font-medium">Halaman 1 dari 2</span>
                    <button class="p-2 rounded-lg bg-[#D9E7E9] shadow-sm hover:bg-[#c0d5d7] transition">
